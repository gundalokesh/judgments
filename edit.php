...
<?php if(!empty($msg)){echo $msg; }?>
    ...
    <form action="updatejudgments.php" method="POST">
      <input type='hidden' name='id' value="<?php echo $editData['id'];?>" />
      <div class="form-fields">
        <div class="field">
          <label>Judgement Number</label>
          <input type="text" id="JudgementNumber" name="judgement_number"
          required value="<?php echo isset($editData) ? $editData['judgement_number'] : '' ?>">
        </div>
        <div class="field">
          <label>Citations</label>
          <input type="text" id="Citations" name='citations'
          required value="<?php echo isset($editData) ? $editData['citations'] : '' ?>">
        </div>
        ...
        <div class="field">
          ...
          required value="<?php echo isset($editData) ? $editData['name_of_court'] : '' ?>">
        </div>
      </div>
      <div class="form-fields">
        <div class="field">
          ...
          required value="<?php echo isset($editData) ? $editData['name_of_judges'] : '' ?>">
        </div>

        <div class="field">
          <label>Number of Judges</label>
          <input type="text" id="NumberofJudges" name=' number_of_judges'
          required value="<?php echo isset($editData) ? $editData['number_of_judges'] : '' ?>">
        </div>
        <div class="field">
          <label>Nature of Case</label>
          <input type="text" id="NatureofCase" name='nature_of_case'
          required value="<?php echo isset($editData) ? $editData['nature_of_case'] : '' ?>">
        </div>
      </div>
      <div class="form-fields">
        <div class="field">
          ...
          required value="<?php echo isset($editData) ? $editData['appellant_name'] : '' ?>">
        </div>
        <div class="field">
          <label>Respondent Name</label>
          <input type="text" id="RespondentName" name='respondent_name'
          required value="<?php echo isset($editData) ? $editData['respondent_name'] : '' ?>">
        </div>
        <div class="field">
          <label>Rank of Judgement</label>
          <input type="text" id="RankofJudgement" name='rank_of_judgement'
          required value="<?php echo isset($editData) ? $editData['rank_of_judgement'] : '' ?>">
        </div>
      </div>
      <div class="form-fields">
        <div class="field">
          ...
          required value="<?php echo isset($editData) ? $editData['category1'] : '' ?>">
        </div>
        <div class="field">
          <label>Category 2 :</label>
          <input type="text" id="Category2" name='category2'
          required value="<?php echo isset($editData) ? $editData['category2'] : '' ?>">
        </div>
        <div class="field">
          <label>Category 3 :</label>
          <input type="text" id="Category3" name='category3' 
          required value="<?php echo isset($editData) ? $editData['category3'] : '' ?>">
        </div>
      </div>
      <div class="txtarea mt-4">
        <p>Description : -</P>
      <textarea  name="content" id="editor" rows="10" cols="80"><?php echo $editData['description'];?></textarea>
      </div>
      <div class="form-fields">
        <div class="field">
          ...
          <input type="file" id="formFile" id="Upload" name='upload'
