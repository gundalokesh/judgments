    ...
    <form action="updatejudgments.php" method="POST">
      ...
      <div class="form-fields">
        ...
        <div class="field">
          ...
          <input type="text" id="JudgementDate" name='judgement_date'
          required value="<?php echo isset($editData) ? $editData['judgement_date'] : '' ?>">
        </div>
        <div class="field">
     ...
     foreach($categories['type1'] as $name) {
      $selected = '';
      if ($name == $editData['category1'])
      $selected = 'selected="selected"';
      ?>
       <option <?php echo $selected; ?> ><?php echo $name; ?></option>
     <?php }
     ?>
       </select>
        </div>
